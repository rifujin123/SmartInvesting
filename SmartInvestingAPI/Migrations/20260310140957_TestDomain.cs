...
{
    /// <inheritdoc />
    public partial class TestDomain : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssetsPricesHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssetsPricesHistory_Assets_AssetId",
                        column: x => x.AssetId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvestmentOrders_Portfolios_PortfolioId",
                        column: x => x.PortfolioId,
                        principalTable: "Portfolios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InvestmentOrders_Wallets_WalletId",
                        column: x => x.WalletId,
                        principalTable: "Wallets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetsPricesHistory_AssetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvestmentOrders_PortfolioId",
                table: "InvestmentOrders",
                column: "PortfolioId");

            migrationBuilder.CreateIndex(
                name: "IX_InvestmentOrders_WalletId",
                table: "InvestmentOrders",
                column: "WalletId");
